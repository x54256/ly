...
//    private PayLogMapper payLogMapper;
    ...
    private void isSignatureValid(Map<String, String> result) {
        try {
            ...
            if (!boo1 && !boo2) {
                throw new LyException(ExceptionEnums.WX_PAY_SIGN_INVALID);
            }
        } catch (Exception e) {
...
//            throw new LyException(ExceptionEnums.WX_PAY_NOTIFY_PARAM_ERROR);
//        }
//
//        //查询订单
